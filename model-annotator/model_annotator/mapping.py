...
RULES: list[OntologyRule] = [
    ...
    OntologyRule("taxes",
                 ...
                 percent_expected=False),
    OntologyRule("pretax_income",
                 exact=("earnings before tax", "earnings before taxes", "ebt", "profit before tax",
                        "profit before taxes", "income before tax", "income before taxes",
                        "pretax income", "pre-tax income", "pretax profit", "net profit before tax",
                        "ebt - net profit/loss before tax", "profit/loss before tax"),
                 keywords=("before tax", "pretax", "pre-tax"),
                 # keep EBIT/EBITDA and after-tax lines out
                 veto=("%", "margin", "growth", "after tax", "ebitda", "ebit ", "interest and tax"),
                 percent_expected=False),
